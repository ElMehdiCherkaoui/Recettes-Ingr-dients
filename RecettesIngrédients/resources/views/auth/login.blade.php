    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md animate-fade-in">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-orange-100">Welcome back to your kitchen</p>
            </div>
                ...
                <form class="space-y-5">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <label class="flex items-center">
                            <input type="checkbox" class="w-4 h-4 text-orange-500 rounded cursor-pointer">
                            <span class="ml-2 text-sm text-gray-600">Remember me</span>
                        </label>
                        <a href="#" class="text-sm text-orange-500 hover:text-orange-600 font-semibold">Forgot password?</a>
                    </div>
            ...
            <div class="text-center">
                <p class="text-white">
                    ...
                    <a href="register" class="font-bold text-orange-200 hover:text-white transition-all">Sign up here</a>
                </p>
            </div>
