        ...
        <div class="w-full max-w-md animate-fade-in">
            ...
            <div class="glass rounded-2xl shadow-2xl p-8 mb-6">
                ...
                <form class="space-y-4" method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Mehdi Cherkaoui" name="name"
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center space-x-2">
                            <div class="flex-1 h-1 bg-gray-300 rounded-full overflow-hidden">
                                <div class="password-strength h-1 rounded-full transition-all duration-300 bg-red-500"
                                    id="strengthBar" style="width: 10%">
                                </div>
                    ...
                    <div class="flex items-start pt-2">
                        ...
                        <label class="ml-2 text-sm text-gray-600">
                            I agree to the
                            <a href="#" class="text-orange-500 font-semibold hover:text-orange-600">Terms of
                                Service</a>
                            and
                            <a href="#" class="text-orange-500 font-semibold hover:text-orange-600">Privacy
                                Policy</a>
                        </label>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button type="button"
                        class="flex items-center justify-center py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all">
            ...
            <div class="text-center">
                <p class="text-white">
                    ...
                    <a href="login" class="font-bold text-orange-200 hover:text-white transition-all">Sign in
                        here</a>
                </p>
            </div>
