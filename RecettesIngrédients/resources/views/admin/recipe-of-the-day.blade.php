        ...
        <aside class="w-64 bg-white border-r border-gray-200 p-6 flex flex-col">
            ...
            <nav class="flex-1 space-y-2">
                ...
                <a href="recipe-of-the-day"
                    class="sidebar-active flex items-center px-4 py-3 rounded-lg transition-all">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="p-6">
                                @if ($recipeOfDay)
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900">
                                                {{ $recipeOfDay->updated_at->format('F d, Y') }}
                                            </p>
                                        </div>
                                ...
                                @else
                                    <div class="text-center text-gray-500 py-20">
                                        No recipe of the day selected yet.
                                    </div>
                                @endif
                            </div>
                        ...
                        <!-- Select New Recipe -->
                        <form method="POST" action="{{ route('admin.recipe_of_day.update') }}">
                            @csrf
                ...
                {{ $recipe->isRecipeOfDay ? 'border-orange-500 bg-orange-50' : 'border-gray-200' }}">

                                        <input type="radio" name="recipe_id" value="{{ $recipe->id }}"
                                            class="mt-1 mr-4" {{ $recipe->isRecipeOfDay ? 'checked' : '' }}>

                                        <div class="flex-1">
                                            <h4 class="font-bold text-gray-900">{{ $recipe->title }}</h4>
                                            <p class="text-sm text-gray-600">
                                                By {{ $recipe->user->name }} • {{ $recipe->category->name }}
                                            </p>
                                        </div>
                                    </label>
                                @endforeach
                            ...
                            <button class="w-full bg-orange-500 text-white font-bold py-2 px-4 rounded-lg mt-6">
                            ...
                            <div class="flex items-start">
                                <svg class="w-5 h-5 text-blue-600 mt-0.5 mr-3 flex-shrink-0" fill="currentColor"
                                    ...
                                    <path fill-rule="evenodd"
                                        d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zm-11-1a1 1 0 100 2h2a1 1 0 100-2H7zm4 0a1 1 0 100 2h2a1 1 0 100-2h-2zm4 0a1 1 0 100 2h.01a1 1 0 100-2H15z"
                                        clip-rule="evenodd"></path>
                                </svg>
                                <div>
                                    <h4 class="font-bold text-blue-900 mb-1">Tip</h4>
                                    <p class="text-sm text-blue-800">Choose recipes with high engagement and ratings
                                        for best results. Update daily for consistent traffic.</p>
                                </div>
                            </div>
                        </div>
                    </div>
