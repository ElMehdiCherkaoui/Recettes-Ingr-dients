        ...
        <main class="flex-1 overflow-auto">
            <div class="p-8">
                <div class="mb-8 flex items-center justify-between">
                    ...
                    <button
                        class="bg-orange-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600 transition-all font-medium flex items-center">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <button
                            class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-all font-medium">
                            Filter
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <button
                                        class="text-orange-500 hover:text-orange-700 font-medium text-sm">Edit</button>
                                    <button
                                        class="text-red-500 hover:text-red-700 font-medium text-sm ml-4">Delete</button>
                                </td>
                            </tr>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-block px-3 py-1 bg-red-100 text-red-700 text-xs font-bold rounded-full">Rejected</span>
                                </td>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                        <p class="text-sm text-gray-600">Showing <span class="font-bold">1</span> to <span
                                class="font-bold">5</span> of <span class="font-bold">245</span> recipes</p>
                        <div class="flex space-x-2">
                            <button
                                class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all">Previous</button>
                            <button class="px-4 py-2 bg-orange-500 text-white rounded-lg">1</button>
                            <button
                                class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all">2</button>
                            <button
                                class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all">Next</button>
                        </div>
                    </div>
                </div>
            </div>
