...
<div class="max-w-5xl mx-auto px-6 py-12">
    ...
    <form action="{{ route('recipes.store') }}" method="POST" class="space-y-8">
        @csrf
        ...
        <div class="bg-white rounded-lg border p-8">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="4" required class="w-full px-4 py-3 border rounded-lg">{{ old('description') }}</textarea>
            </div>

            <!-- Steps -->
            <div class="mb-6">
                <label class="block font-semibold mb-2">Steps *</label>
                <textarea name="steps" rows="5" required class="w-full px-4 py-3 border rounded-lg"
                    placeholder="Step 1... Step 2...">{{ old('steps') }}</textarea>
            </div>

            <!-- Image -->
            <div class="mb-6">
                <label class="block font-semibold mb-2">Recipe Image *</label>
                <input type="file" name="image" required class="w-full px-4 py-3 border rounded-lg">
            </div>
        </div>
